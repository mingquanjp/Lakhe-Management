...
(
    ...
    -- 'Permanent', 'MovedOut', 'Deceased', 'Temporary'
...
(
    ...
    -- Ngày thay đổi
    change_type VARCHAR(50) NOT NULL CHECK (change_type IN ('Split', 'MoveOut', 'Temporary', 'Death', 'NewBirth', 'Added', 'Removed', 'ChangeHeadOfHousehold', 'CreateFee', 'UpdateFee', 'DeleteFee', 'UpdateInfo')),
    -- 'Split', 'MoveOut', 'Temporary', 'Death', 'NewBirth', 'Added', 'Removed', 'ChangeHeadOfHousehold', 'CreateFee', 'UpdateFee', 'DeleteFee', 'UpdateInfo'
