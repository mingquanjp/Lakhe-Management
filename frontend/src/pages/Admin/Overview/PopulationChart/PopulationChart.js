    ...
    <div className="chart-card line-chart-container">
      ...
      <ResponsiveContainer width="100%" height={250}>
        <LineChart data={data}>
          ...
          <Tooltip />
          <Line type="monotone" dataKey="total" stroke="#333" strokeWidth={2} dot={false} />
          <Line type="monotone" dataKey="temp" stroke="#74b9ff" strokeWidth={2} dot={false} strokeDasharray="3 3" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  );
