...
import "./HouseholdTemporarySplitModal.css";
...
const HouseholdTemporarySplitModal = ({ isOpen, onClose, householdData, onSave }) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={handleClose} title="Tách hộ khẩu tạm trú" size="xl">
      <div className="household-split-modal">
        <div className="step-1">
          ...
          <div className="info-box">
            <p>
              <strong>Thành viên hiện tại:</strong> {getMembersList().length} người
            </p>
            <p>
              <strong>Sẽ chia thành:</strong> {splitCount || "?"} hộ
            </p>
          </div>
        </div>
...
export default HouseholdTemporarySplitModal;
